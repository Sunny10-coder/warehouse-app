...
export default function Schedule() {
  ...
  const assignShifts = useMemo(() => [
    ...
    { key: "ega", label: "EGA Site", time: "07:00 - 16:00", color: theme.blue },
    { key: "sat_day", label: "Sat Day", time: "06:00 - 18:00", color: theme.primary },
    { key: "sat_night", label: "Sat Night", time: "18:00 - 06:00", color: theme.yellow },
    { key: "sun_day", label: "Sun Day", time: "06:00 - 18:00", color: theme.primary },
    { key: "sun_night", label: "Sun Night", time: "18:00 - 06:00", color: theme.yellow },
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]} edges={["top"]}>
      <View style={[styles.header, { backgroundColor: theme.surface, borderBottomColor: theme.border, borderWidth: 1 }]}>
        <View style={{ flex: 1 }}>
      ...
      <View style={[styles.toggleRow, { backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]}>
        <TouchableOpacity
      ...
      <View style={[styles.rosterRange, { backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]}>
        <TouchableOpacity
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            <View style={[styles.entryCard, { borderLeftColor: sc.c, backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]} testID={`schedule-entry-${item.user_id}`}>
              {item.avatar_url ? (
      ...
      {isAdmin && (
        <Modal visible={bulkOpen} transparent animationType="fade" onRequestClose={() => setBulkOpen(false)}>
          <View style={[styles.modalBackdrop, { backgroundColor: "rgba(0,0,0,0.8)" }]}>
            <View style={[styles.bulkModal, { backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]}>
      ...
      {isAdmin && inlineEditUser && (
        ...
        >
          <View style={[styles.modalBackdrop, { backgroundColor: "rgba(0,0,0,0.8)" }]}>
            <View style={[styles.inlineEditModal, { backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]}>
              <View style={styles.bulkHeader}>
