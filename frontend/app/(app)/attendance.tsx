  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.bg }]} edges={["top"]}>
      ...
      >
        ...
        {/* Today card */}
        <View style={[styles.todayCard, { borderLeftColor: sc.c, backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]}>
          {todaySched ? (
            <>
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statBox, { backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]}>
        ...
        {records.length === 0 ? (
          ...
          records.slice().reverse().map((r, i) => {
            ...
            return (
              <View key={i} style={[styles.historyRow, { backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]} testID={`attendance-record-${i}`}>
